...
//                   <TableCell className="table-cell">{role.permissions}</TableCell>
//                   <TableCell className="table-cell">
//                     <IconButton
//                       className="action-icon"
//                       onClick={() => {
...
// // Planetary Background Component
...
// import React, { useState, useEffect } from "react";
// import { Container, Grid, Typography, Button, Dialog, DialogTitle, DialogContent, DialogActions, TextField, Table, TableBody, TableCell, TableHead, TableRow, IconButton } from "@mui/material";
// import { Edit, Delete } from "@mui/icons-material";
// import axios from "axios";
// import { toast } from "react-toastify";
// import { Canvas, extend } from "@react-three/fiber";
...
//         </DialogContent>
//         <DialogActions>
//           <Button onClick={() => setRoleDialogOpen(false)} color="secondary">
//             Cancel
//           </Button>
//           <Button onClick={handleRoleSubmit} color="primary">
